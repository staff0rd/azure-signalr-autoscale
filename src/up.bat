...
az signalr key list -n autoscale-free -g azure-signalr --query primaryConnectionString -o tsv
...
dotnet bin\debug\netcoreapp3.0\BenchmarkServer.dll Azure:SignalR:<connectionStringFromAbove>
